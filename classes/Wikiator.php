...
class Wikiator
{
	...
	public function editWikiPage( $lstrPageTitle, $lstrWikiText, $lstrEncodedTitle = '', $lstrComments = "", $lstrCaptchaID = '', $lstrCaptchaWord = '' )
	{
		...
		}elseif( preg_match( '/result="Success"/', $this->strResponse ) )
		{
			...
			return "Edit successful! Page id -> {$this->strPageId}<br/><br/><a id=\"wiki_page_link\" target=\"_blank\" href=\"http://en.wikipedia.org/wiki/{$this->strPageTitle}\">View the Wiki page you just edited!</a>";
		}else
		{
