...
//	validateXML();
	...
	$.get('get_wiki.php', {ead_path : eac_xml_path}, function(markup) {
		...
		{
			$('#main_content').append("<div id=\"wikieditor\"><div class=\"wiki_container\"><h1>Local article (transformed from EAC-CPF record) <a style=\"font-size:small; float:right; margin-top:3px;\" target=\"_blank\" href=\"https://en.wikipedia.org/wiki/Help:Wiki_markup\">Help with wiki markup</a></h1> \
