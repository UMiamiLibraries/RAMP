...
<div class="pure-g-r">
  <div class="pure-u-1">
    <div class="content_box" id="about_box">
      <h1>About RAMP</h1>
      <p>The Remixing Archival Metadata Project (RAMP) was built to increase visibility of archival collections by making their holdings discoverable through Wikipedia.</p>
      <p>RAMP is a collaborative effort that has brought together curators, programmers, and cataloging and metadata librarians at the <a href="http://library.miami.edu/" target="_blank">University of Miami Libraries</a> in Coral Gables, Florida. RAMP is open source software available under an <a href="http://opensource.org/licenses/ECL-2.0" target="_blank">Educational Community License, Version 2.0</a> (ECL-2.0) and can be downloaded from <a href="https://github.com/UMiamiLibraries/RAMP" target="_blank">GitHub</a>.</p>
